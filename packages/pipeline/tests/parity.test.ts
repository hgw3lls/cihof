 ...
 *
 * The reference is a frozen fixture, not `public/data/cihof-runtime-data.json`.
 * That file is regenerated by `npm run prepare:data`, so comparing against it
 * live meant the oracle moved whenever the thing it was meant to check moved:
 * a regeneration could absorb a dropped decision and the test would still pass,
 * and the day the old pipeline is retired the comparison would quietly become a
 * comparison against nothing. The fixture holds the published record still.
 *
