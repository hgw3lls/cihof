...
const metadata = {
  ...
  reviewGuidance: {
    ...
    countryTagCandidates: 'Generated from country and nationality references in source text. Copy only reviewed labels into approvedCountryTags.',
    countryNotes: 'Evidence note for generated or inferred country candidates. Rewrite or clear after curator review.',
...
function buildCuratedRecord(inductee, featuredCandidate) {
  return {
    ...
    approvedCountryTags: [],
    countryNotes: inductee.countryTagsNote,
