...
- [ ] `release/app/` holds `CIHOF-Exhibit-Setup-<version>.exe` and `STAFF-GUIDE.md`.
      Copy both to a USB drive. **Not** to a shared or online folder: it carries kiosk-only films.
