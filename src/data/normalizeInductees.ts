...
function normalizeInductee(value: unknown, index: number): Inductee | null {
  ...
  return {
    ...
    documentedContextLine: readString(value.documentedContextLine, ''),
    honoredForSummary: readString(value.honoredForSummary, ''),
    lifeWorkSummary: readString(value.lifeWorkSummary, ''),
    ...
    communityTagsSource: readString(value.communityTagsSource, ''),
    sortName: readString(value.sortName, name),
    pronunciation: readString(value.pronunciation, ''),
    imageAltText: readString(value.imageAltText, name),
    imageFocalPoint: readString(value.imageFocalPoint, 'center'),
