...
Training walkthroughs, with screenshots: [`docs/training/gallery-staff.md`](docs/training/gallery-staff.md) for gallery staff and [`docs/training/review-app.md`](docs/training/review-app.md) for reviewers.
